...
def api_clip_sh():
    ...
    # CORREÇÃO: Extrair valores individuais do dicionário
    # A função lógica espera: (points, x_min, y_min, x_max, y_max)
    ...
    clipped_polygon = lg.sutherland_hodgman_clip(subject, x_min, y_min, x_max, y_max)
